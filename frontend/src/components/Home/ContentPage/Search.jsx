...
const Search = () => {
  ...
  return (
    <div className='flex items-center w-full md:w-1/2 px-1 gap-1 bg-search text-secondaryGray font-secondary rounded-small my-2 '>
        ...
        <Input type="text" placeholder="Search" className="text-primary shadow-none border-none rounded-none focus:border-none focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 md:py-6" onChange={(e)=>dispatch(setSearchValue(e.target.value))}  value={searchVal} />
